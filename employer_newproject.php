		...
		if(!empty($_POST['qualification']))
		 {
		   ...
		   $qe="insert into project(employer,title,description,skills,budget,time,submission,active,qualification) values('". $_SESSION['employer_userid'] . "', '$title', '$description', '$skills', '$budget', '$time', '$submission', 1, '$qualification')";		   
										...
										<div class="field-column row">
											<div class="col-sm-6">
												<div class="field">
													...
													<input type="date" name="submission" value="">
												</div>
											</div>											
										</div> <!-- .field-column -->
