<?php 
	...
	$q="Select project.*,employer.name employername from project join employer on employer.sr_no=project.employer";
                                    ...
                                    <div class="table-responsive">
										<table class="table table-striped table-bordered table-hover" id="dataTables-example">
											...
											<?php	
												...
												echo "<td>$row[5]</td>";
												echo "<td>$row[6]</td>";
												echo "<td ><a href='admin_viewapplication.php?id=$row[id]'>Application</a> &nbsp;&nbsp; </td></tr>";
												}	
											?>
